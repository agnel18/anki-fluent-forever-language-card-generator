...
1. LANG_CODE_PLACEHOLDER_config.py - Configuration loading and language metadata
...
4. LANG_CODE_PLACEHOLDER_response_parser.py - AI response parsing and standardization
