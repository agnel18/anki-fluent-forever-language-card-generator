...
LANGUAGE_NAME_TO_CODE = {
    'arabic': 'ar', 'Arabic': 'ar', 'Modern Standard Arabic': 'ar',
    'chinese_simplified': 'zh', 'chinese_traditional': 'zh-tw',
    'chinese (simplified)': 'zh', 'chinese (traditional)': 'zh-tw',
    'Chinese (Simplified)': 'zh', 'Chinese (Traditional)': 'zh-tw',
    'Chinese': 'zh', 'Chinese Simplified': 'zh', 'Chinese Traditional': 'zh-tw',
    'hindi': 'hi', 'Hindi': 'hi',
    ...
    'burmese': 'my', 'Burmese': 'my', 'Myanmar (Burmese)': 'my',
    ...
    'sinhala': 'si', 'Sinhala': 'si', 'Sinhala (Sinhalese)': 'si',
    'slovak': 'sk', 'Slovak': 'sk',
