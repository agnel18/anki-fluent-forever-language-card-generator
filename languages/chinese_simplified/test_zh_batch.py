...
"""
Batch processing tests for zh analyzer.
...
class TestZhAnalyzerBatchProcessing:
    ...
    def test_batch_processing_structure(self, analyzer):
        ...
        with patch('languages.chinese_simplified.zh_analyzer.get_gemini_api') as mock_get_api:
            mock_api = Mock()
