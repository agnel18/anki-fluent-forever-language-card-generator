...
"""
Content generation tests for hi analyzer - AI-powered sentence generation.
"""
...
class TestHiAnalyzerContentGeneration:
    ...
    def test_language_specific_prompts(self, analyzer):
        ...
        assert prompt is not None
        assert analyzer.language_code.upper() in prompt or analyzer.language_code in prompt
