#!/usr/bin/env python3
"""Test Hindi analyzer color consistency"""
...
def test_hindi_colors():
    ...
    print(f"Testing Hindi analyzer with sentence: '{sentence}'")
    ...
    print("\nColor consistency fix has been implemented!")
    print("- AI prompts now specify exact hex codes for each grammatical role")
    print("- Post-processing standardization ensures colors match the scheme")
